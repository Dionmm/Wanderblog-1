        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Register for Wanderblog</h4>
                </div>
                <div class="modal-body" id="register-modal">
                    <form onsubmit="registerForm()"  method="POST" id="registerForm">
                        ...
                        <label for="passwordConf">Confirm Password:<input type="password" name="passwordConf" required></label><br>
                        <label for="email">Email:<input type="email" name="email" required></label><br>
                        <label for="firstName">First Name:<input type="text" name="firstName" required></label><br>
                        <label for="lastName">Last Name:<input type="text" name="lastName" required></label><br>
                        <label for="country">Country:<select name="country" required>
